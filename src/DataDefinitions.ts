...
const climateDefinition = (builder: ClimateDataDefinitionBuilder): DataDefinition => ({
    name: builder.name,
    id: getClimateDataId,
    units: builder.units ?? "",
    formatter: builder.formatter ?? regularNumber,
    color: builder.color,
    normalizations: builder.normalizations ?? raw,
...
const genericDefinition = (builder: DataDefinitionBuilder): DataDefinition => ({
    name: builder.name,
    id: getRegularId,
    units: builder.units ?? "",
    formatter: builder.formatter ?? regularNumber,
    ...
    mapType: builder.mapType ?? MapType.Choropleth,
});
