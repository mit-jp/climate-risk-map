            ...
            <main className={css.page}>
                ...
                <Container className={css.container}>
                    ...
                    <Typography variant="h6" component="p" className={css.subtitle}>
                        ...
                        Socioeconomic Stressors. STRESS is a publicly available platform that
                        enables people to select, weight, and combine various socioeconomic and
                        environmental factors to identify these ‘risk hotspots.’ STRESS currently
                        allows users to create ‘combined relative risk scores’ for counties across
                        the United States. Users can choose amongst over 20 datasets representing
                        aspects of socioeconomic and environmental risk. The platform
                        percentile-ranks each county for each metric, then averages these
                        percentiles using the users’ weighting to calculate the combinatory risk
                        score. Users are immediately shown a USA-wide county level map of these
                        relative risks. For more information, users can click to zoom into a county;
                        they will see relative risk scores now calculated only relative to other
                        counties in the same state and they can view a ‘report card’ for their
                        county. While many risk and vulnerability index mapping platforms exist,
                        STRESS differentiates itself by allowing users to select and weight metrics
                        for themselves, as opposed to providing pre-constructed indices. This makes
                        it adaptable to the needs of a diverse user base with differing values,
                        interests, background knowledge, goals, and abilities to intervene. In
                        addition to allowing users to combine metrics, STRESS provides a centralized
                        platform where users can easily view over 100 USA wide county-level
                        datasets, over 20 country-level global datasets, and several city-level
                        datasets from local partnerships. Although STRESS does not produce its own
                        data, it provides an important service by bringing datasets from various
                        agencies into one platform to increase accessibility. We are continually
                        updating STRESS with a broad range of up-to-date datasets and forming new
                        partnerships.
                    </Typography>
                </Container>
            </main>
