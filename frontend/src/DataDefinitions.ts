...
export enum DataGroup {
    ...
    PM2_5 = "PM2_5",
    Deaths_0_5 = "deaths_0-5_all",
    Deaths_25_plus = "deaths_25+_all",
    Deaths_5_25 = "deaths_5-25_all",
    ...
    Mortality_0_5 = "mort_0-5_all",
    Mortality_5_25 = "mort_5-25_all",
    Mortality_25_plus = "mort_25+_all",
    ...
    Mortality_0_5_est = "mort_0-5_all_est",
    Mortality_5_25_est = "mort_5-25_all_est",
    Mortality_25_plus_est = "mort_25+_all_est",
    Mortality_0_5_circ_est = "mort_0-5_circ_est",
    Mortality_5_25_circ_est = "mort_5-25_circ_est",
    Mortality_25_plus_circ_est = "mort_25+_circ_est",
    Mortality_0_5_resp_est = "mort_0-5_resp_est",
    Mortality_5_25_resp_est = "mort_5-25_resp_est",
    Mortality_25_plus_resp_est = "mort_25+_resp_est",
...
We estimate death rates for such counties based on state-level averages.`
...
const dataDefinitions = OrderedMap<DataGroup, DataDefinition>([
    ...
    [DataGroup.Mortality_0_5_est, genericDefinition({
        name: () => "Estimated Death Rate, ages 0 to 5",
        units: "deaths per 1,000 people per year",
        color: scaleSequential([0, 3], scales.interpolateYlOrBr),
        type: DataType.Health,
        mapType: MapType.Choropleth,
    ...
    [DataGroup.Mortality_5_25_est, genericDefinition({
        name: () => "Estimated Death Rate, ages 5 to 25",
        units: "deaths per 1,000 people per year",
        color: scaleSequential([0, 1], scales.interpolateYlOrBr),
        type: DataType.Health,
        mapType: MapType.Choropleth,
    ...
    [DataGroup.Mortality_25_plus_est, genericDefinition({
        name: () => "Estimated Death Rate, ages 25+",
        units: "deaths per 1,000 people per year",
        color: scaleSequential([5, 25], scales.interpolateYlOrBr),
        type: DataType.Health,
        mapType: MapType.Choropleth,
    ...
    [DataGroup.Mortality_25_plus_circ_est, genericDefinition({
        name: () => "Estimated Circulatory Death Rate, ages 25+",
        units: "deaths per 1,000 people per year",
        color: scaleSequential([0, 10], scales.interpolateYlOrBr),
        type: DataType.Health,
        mapType: MapType.Choropleth,
    ...
    [DataGroup.Mortality_25_plus_resp_est, genericDefinition({
        name: () => "Estimated Respiratory Death Rate, ages 25+",
        units: "deaths per 1,000 people per year",
        color: scaleSequential([0, 4], scales.interpolateYlOrBr),
        type: DataType.Health,
        mapType: MapType.Choropleth,
